...
function ExistingClient() {
  ...
  const send = (e) => {
    ...
    emailjs
      .sendForm("service_rhf8df6", "template_38xcieh", "#existingClient")
      .then((data) => {
        console.log(data)
        setSubmitting(false)
        setSubmitted(true)
  ...
  return (
    <form id="existingClient" onSubmit={send}>
      {submitted ? (
        ...
        >
          <Grid xs={12} md={10}>
            <Input fullWidth underlined name="name" id="name" labelPlaceholder="NAME*" />
          </Grid>
          {/* <Grid xs={12} sm={6} md={5}>
          <Input fullWidth underlined name="name" id="name" labelPlaceholder="LAST NAME*" />
        </Grid> */}
          <Grid xs={12} sm={6} md={5}>
          ...
          <Grid xs={12} md={10}>
            <Input fullWidth underlined name="email" id="email" labelPlaceholder="EMAIL*" />
          </Grid>
          <Grid xs={12} md={10}>
